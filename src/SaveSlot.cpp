...
int SaveSlotMenu::drawSaveSlotMenu(int data[][6], float dataTime[]) {
    ...
    if (data[0][0] == 1) {
        ...
        string time = "Time: " + std::to_string(dataTime[0]);
        DrawText(time.c_str(), (float)SCREEN_WIDTH / 2 + saveSlotTable.width / 4 - 70, (float)SCREEN_HEIGHT / 2 - saveSlotTable.height / 2 + 250, 40, BLACK);
    }
    else {
    ...
    if (data[1][0] == 1) {
        ...
        string time = "Time: " + std::to_string(dataTime[1]);
        DrawText(time.c_str(), (float)SCREEN_WIDTH / 2 + saveSlotTable.width / 4 - 70, (float)SCREEN_HEIGHT / 2 - saveSlotTable.height / 2 + 440, 40, BLACK);
    }
    else {
    ...
    if (data[2][0] == 1) {
        ...
        string time = "Time: " + std::to_string(dataTime[2]);
        DrawText(time.c_str(), (float)SCREEN_WIDTH / 2 + saveSlotTable.width / 4 - 70, (float)SCREEN_HEIGHT / 2 - saveSlotTable.height / 2 + 630, 40, BLACK);
    }
    else {
