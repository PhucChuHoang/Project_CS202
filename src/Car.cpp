...
Car::Car(float speed, Direction direction, float y): 
    MovingEntity(&(Global::get().carSound),(direction == DIRECTION_LEFT)? Global::get().vehicleTexture[GetRandomValue(0, 4)][0]: Global::get().vehicleTexture[GetRandomValue(0, 4)][1], speed, 0 , y), direction(direction) {
